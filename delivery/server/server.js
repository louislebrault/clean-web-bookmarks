...
const mongoPlug = require('../../data/mongo_plug')
...
app.on('request', async(req, res) => {
  ...
  if (req.method == "GET") {
    switch (req.url) {
      case '/':
        sendFileContent(res, '../web/public/index.html', 'text/html')
        break
      case '/style.css':
        sendFileContent(res, '../web/public/style.css', 'text/css')
        break
      case '/client.js':
        sendFileContent(res, '../web/public/client.js', 'application/javascript')
        break
      default:
        res.end()
    }
